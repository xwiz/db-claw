 ...
 */
export async function scanPrismaSchemas(root: string): Promise<PrismaScanResult> {
...
export function parsePrismaSchema(file: string, text: string): PrismaScanResult {
    const result: PrismaScanResult = { fragments: [], skipped: [] };
...
// custom type and skipped at v0.5.

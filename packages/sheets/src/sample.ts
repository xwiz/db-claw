...
export const SHEET_USE_CASES: SheetUseCase[] = [
	{
		...
		questions: [
			...
			"Compare average order value by segment for active accounts",
			"What are the top 5 customers by revenue?",
			"Show high renewal risk LATAM accounts with revenue over 2000",
			"How many active annual accounts are high renewal risk?",
		],
	},
	{
		id: "support_queue",
		...
		csv: SUPPORT_CSV,
		questions: [
			"Which team has the most open high priority tickets?",
			"Compare average response time hours by team for breached SLA tickets",
			"Show open high priority tickets with response time over 8",
			"Compare average satisfaction score by product area for closed tickets",
			"How many open tickets breached first reply SLA?",
		],
	},
	{
		id: "inventory",
		...
		csv: INVENTORY_CSV,
		questions: [
			"Compare low stock units on hand by warehouse",
			"Compare total units on hand by category for East warehouse",
			"Show low stock products with units on hand below 15",
			"Which supplier has the highest average unit cost?",
			"How many security products are backordered?",
		],
	},
	{
		...
		csv: MARKETING_CSV,
		questions: [
			"Compare active campaign spend by channel",
			"Compare average leads by region for active campaigns",
			"Show active campaigns with conversions over 10",
			"Compare total conversions by owner",
			"How many paused Search campaigns are there?",
		],
	},
	{
		id: "applicant_kyc",
		...
		csv: APPLICANT_CSV,
		questions: [
			"Compare total wallet balance by country for approved applicants",
			"How many high risk applicants by reviewer?",
			"Show review applicants with wallet balance over 1500",
			"How many approved applicants have passport?",
			"Show partner applicants not from Nigeria",
	...
	},
	{
		...
		questions: [
			"Compare total cost by subsystem for high criticality components",
			"Compare average lead time days by sourcing option",
			"Show high criticality components with lead time days over 10",
			"Compare total quantity by subsystem for hardware store components",
			"How many online components are high criticality?",
	...
	},
	{
		...
		csv: CLINIC_CSV,
		questions: [
			"Compare completed visit cost by department",
			"Compare average wait time minutes by department",
			"Show completed visits with wait time minutes over 40",
			"Which provider has the highest average wait time minutes?",
			"Compare no-show patients by department",
			"How many private insurance appointments were completed?",
		],
	},
];

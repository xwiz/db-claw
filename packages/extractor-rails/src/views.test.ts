...
describe("inferEntityFromPath", () => {
    it("singularises plural directory names", () => {
        ...
        expect(
            inferEntityFromPath("/repo/app/views/order_items/_form.haml"),
        ).toBe("order_item");
    });
    ...
    it("handles `-es` plurals (addresses, classes)", () => {
        expect(
            inferEntityFromPath("/repo/app/views/addresses/edit.html.erb"),
        ).toBe("address");
    ...
    it("handles irregular plurals", () => {
        ...
        expect(
            inferEntityFromPath("/repo/app/views/children/index.html.erb"),
        ).toBe("child");
    });

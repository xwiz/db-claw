...
function emitAdminLabels(
    ...
    for (let i = 0; i < body.namedChildCount; i++) {
        ...
        if (stmt.type === "function_definition") {
            ...
            funcDef = stmt.namedChildren.find((c) => c.type === "function_definition") ?? null;

...
import { SanitiserError, sanitiseCanonical, sanitiseLabel } from "./sanitise.js";

describe("sanitiseCanonical", () => {
    it.each(["users", "tenant_id", "_private", "col42", "a"])("accepts %s", (n) => {
    ...
    it("rejects non-string input", () => {
        expect(() => sanitiseCanonical(42 as unknown as string)).toThrow(SanitiserError);
    });
});

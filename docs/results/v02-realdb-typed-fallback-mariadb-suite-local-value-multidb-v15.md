...
- render errors: `0`
- execution ok: `51/53`
- expected table/field matches: `50/53`
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---|
| 20260604 | `mailer_web` | `FAIL` | `17` | `15` | `15` | `15` | `0` | `0` | `target\realdb_typed_fallback_mariadb_suite_local_value_multidb_v15\seed-20260604` |
| 20260605 | `fraud_radar` | `PASS` | `18` | `18` | `18` | `18` | `0` | `0` | `target\realdb_typed_fallback_mariadb_suite_local_value_multidb_v15\seed-20260605` |
| 20260606 | `fraud_radar` | `FAIL` | `18` | `18` | `18` | `17` | `0` | `0` | `target\realdb_typed_fallback_mariadb_suite_local_value_multidb_v15\seed-20260606` |

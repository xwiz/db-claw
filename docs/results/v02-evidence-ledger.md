...
| Area | Anchor | Reports |
|---|---:|---|
| Core | `pilot_safe`; wrong SQL `0`; gaps `0`; #3 signals `0`; virtual atlas added | [rerun](v02-result-provenance-cleanup-v1.md), [#3](v02-boundqueryplan-issue3-audit-v1.md), [atlas](v02-virtual-semantic-atlas-tables-v1.md), [ready](v02-production-readiness-release-candidate-v1.md), [core](v02-pathway-benchmark-bound-plan-v30.md) |

...
| Benchmarks/research | BIRD100 ONNX `3/100`, route-used wrong `26/29`; atlas first50 v2 `3/50`, accepted wrong `7/10`; direction is DB-only atlas/codebook enrichment, not static examples | [BIRD100](v02-bird100-onnx-diagnostic-v1.md), [atlas50](v02-bird50-benchmark-atlas-v2.md), [direction](v02-bird-semantic-atlas-direction-v1.md), [focused](v02-focused13-full-recovery-slice.md), [shard](v02-realdb-mailer-web-sharding-audit-cleaned-v2.md) |

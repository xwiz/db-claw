...
| Area | Anchor | Reports |
|---|---:|---|
| Core | `pilot_safe`; CI/release `31/31`; canary `144/144 + 18/18`; runtime `59/59`; wrong SQL `0` | [ready](v02-production-readiness-after-cli-fallback-cleanup-v1.md), [core](v02-pathway-benchmark-bound-plan-v30.md), [para](v02-pathway-benchmark-paraphrase-v5.md), [alias](v02-pathway-benchmark-random-alias-breadth-v1.md) |

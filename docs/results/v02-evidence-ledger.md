...
| Benchmarks | BIRD100 `3/100`; first20 `7/20`, wrong `0`; threshold probes bail `2/2`; targeted `7/7`; intent codebook live; graph load slow | [BIRD100](v02-bird100-onnx-diagnostic-v1.md), [atlas50](v02-bird50-benchmark-atlas-v6.md), [desc](v02-bird50-benchmark-atlas-desc-v1.md), [direction](v02-bird-semantic-atlas-direction-v1.md), [focused](v02-focused13-full-recovery-slice.md), [shard](v02-realdb-mailer-web-sharding-audit-cleaned-v2.md) |

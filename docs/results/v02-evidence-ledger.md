...
| Frameworks | primary evidence: Laravel, fraudv, Next, extractor bridge | [direction](v02-app-context-first-direction-v1.md), [bridge](v02-framework-extract-bridge-probe-v2.md), [Laravel](v02-real-app-framework-mailer-web-v2.md) |

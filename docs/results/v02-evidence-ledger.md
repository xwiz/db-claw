...
Date: 2026-06-07. Anchors only; status: [current](v02-current-status.md).
...
| Benchmarks | BIRD100 ONNX `3/100`, route-wrong `26/29`; first50 v6/desc `3/50`, emitted `3`, wrong `0`; use DB-only atlas, not static examples | [BIRD100](v02-bird100-onnx-diagnostic-v1.md), [atlas50](v02-bird50-benchmark-atlas-v6.md), [desc](v02-bird50-benchmark-atlas-desc-v1.md), [direction](v02-bird-semantic-atlas-direction-v1.md), [focused](v02-focused13-full-recovery-slice.md), [shard](v02-realdb-mailer-web-sharding-audit-cleaned-v2.md) |

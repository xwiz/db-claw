...
| Area | Anchor | Reports |
|---|---:|---|
| Core | `pilot_safe`; CI/release-gated `31/31`; canary `144/144 + 18/18`; runtime `59/59`; `0` wrong SQL | [ready](v02-production-readiness-after-cli-fallback-cleanup-v1.md), [core](v02-pathway-benchmark-bound-plan-v30.md), [para](v02-pathway-benchmark-paraphrase-v5.md), [alias](v02-pathway-benchmark-random-alias-breadth-v1.md) |
...
| Frameworks | bridge `5/5`; Laravel `4962/4962`, `13/13`, `6/6`; Next.js `174/174`, `5/5`; launcher `6/6`; dlx `4/4`; local registry `6/6`; packages `9/9` | [bridge](v02-framework-extract-bridge-probe-v2.md), [Laravel](v02-real-app-framework-mailer-web-v2.md), [fraudv](v02-real-app-framework-fraudv-v1.md), [Next](v02-real-app-framework-hostshell-nextjs-v3.md), [pkg](v02-package-bridge-probe-v1.md), [launcher](v02-package-launcher-smoke-v1.md), [dlx](v02-package-dlx-smoke-v1.md), [registry](v02-package-registry-smoke-v1.md), [pack](v02-npm-release-package-check-v1.md), [publish](v02-npm-publish-helper-dryrun-v1.md) |
...
Promote only with `0` wrong accepted SQL and fail-closed non-routes; treat BIRD and pre-cleanup v10-v17 as research only.

...
| Fallback | fail-closed; provider `6/6 + 3/3`; safety `6/6 + 4/4`; shapes pass; multi-series `15/15`; physical-family ambiguity surfaced | [safety](v02-llm-resolution-safety-boundary-v1.md), [mixed](v02-llm-resolution-mixed-safety-v1.md), [live](v02-live-provider-openai-batch-v1.md), [shape](v02-provider-result-shape-contract-v1.md), [multi](v02-realdb-typed-fallback-result-shape-multiseries-v1.md), [family](v02-rejection-packet-physical-family-evidence-v1.md) |

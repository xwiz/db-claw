...
| Benchmarks | BIRD100 ONNX `3/100`, route-wrong `26/29`; first50 desc `3/50`; first20 current `5/20`, wrong `0`, bails `15`; targeted desc slice `5/5`, wrong `0`, bailed `0`; graph load/startup remains slow | [BIRD100](v02-bird100-onnx-diagnostic-v1.md), [atlas50](v02-bird50-benchmark-atlas-v6.md), [desc](v02-bird50-benchmark-atlas-desc-v1.md), [direction](v02-bird-semantic-atlas-direction-v1.md), [focused](v02-focused13-full-recovery-slice.md), [shard](v02-realdb-mailer-web-sharding-audit-cleaned-v2.md) |
